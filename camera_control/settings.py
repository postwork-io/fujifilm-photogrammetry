...
POLARIZER_STEPPER_PIN = int(os.getenv("POLARIZER_STEPPER_PIN") or 12)
POLARIZER_DIRECTION_PIN = int(os.getenv("POLARIZER_DIRECTION_PIN") or 23)
TURNTABLE_STEPS_PER_ROTATION = int(os.getenv("TURNTABLE_STEPS_PER_ROTATION") or 800)
POLARIZER_STEPS_PER_ROTATION = int(os.getenv("POLARIZER_STEPS_PER_ROTATION") or 800)
